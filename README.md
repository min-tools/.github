...
<p align="center">
  Min Tools is a growing collection of focused apps for desktop platforms.<br>
  The current macOS apps are written in Swift, run in the App Sandbox, and have their source on GitHub. No Min&nbsp;Tools accounts, analytics, or servers.
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Linux-coming-FCC624?logo=linux&logoColor=111111" alt="Linux coming">
  <img src="https://img.shields.io/badge/macOS-14%2B-000000?logo=apple&logoColor=white" alt="macOS 14 or later">
  <img src="https://img.shields.io/badge/Windows-coming-0078D4?logo=windows11&logoColor=white" alt="Windows coming">
...
See each platform and app page for current system requirements, permissions, and network use.
...
The macOS versions of Langmin, Pastemin, and Netmin currently require an Apple-silicon Mac running macOS 14 or later. Some Langmin features require newer macOS versions, an enabled Apple feature, or an account with the provider you choose.
